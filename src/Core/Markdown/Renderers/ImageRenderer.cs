...
internal static class ImageRenderer
{
    ...
    public static Task<IRenderable> RenderImageAsync(string altText, string imageUrl, int? maxWidth = null, int? maxHeight = null)
    {
        return Task.FromResult(RenderImage(altText, imageUrl, maxWidth, maxHeight));
    }
    ...
    public static Task<IRenderable> RenderImageInlineAsync(string altText, string imageUrl, int? maxWidth = null, int? maxHeight = null)
    {
        return Task.FromResult(RenderImageInline(altText, imageUrl, maxWidth, maxHeight));
    }
    ...
    public static string? GetLastImageError()
    {
        return _lastImageError;
    }
    ...
    /// </summary>
    /// <returns>The last error message, if any</returns>
    public static string? GetLastSixelError()
    {
        return _lastSixelError;
    }
